...
/*
    Parameters:
    i - function used to iterate over the loop.
    test - function used to test whether to stop the loop or keep going.
    update - function used to update the value of i.
    body - function that will execute the code of the loop.
*/
